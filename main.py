...
def parse_agrs():
    ...
    parser.add_argument('--chexnet_checkpoint', type=str, default="/kaggle/working/medicap-r2gen/best_checkpoint.pth.tar", help='cheXnet checkpoint.')
...
def main():
    # parse arguments
    args = parse_agrs()
    wandb.init(id=args.wandb_id, project="medicap-r2gen", entity="raveen_hansika", resume=True)
    # fix random seeds
